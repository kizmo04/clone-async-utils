...
export default function memoize (fn, hasher) {
    return function memoized (item, callback) {
        let memo = {};
        let args = Array.prototype.slice.call(arguments, 0, fn.length);
        let index = hasher ? hasher.apply(this, args) : JSON.stringify(args);
